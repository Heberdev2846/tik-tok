...
const Navbarizq = () => {
  return (
    <div className="ml-4 w-64 h-[650px] overflow-y-auto">
        <ul className="mt-20">
          ...
          <hr className=" border-zinc-600 mt-4"></hr>
        </ul>
        <p className="mt-4 text-sm text-zinc-700">Cuentas que sigues</p>
        <ul className="mt-3">
          <li className="mb-2">
            <a className="flex items-center" href="">
              <img
              ...
              <div>
                <p>El forrex</p>
                <p className="text-xs">El forrex</p>
              </div>
            </a>
          </li>
          <li className="mb-2">
        ...
        <a className="" href="">
          <p className="text-red-800 mt-2 font-semibold">Ver más</p>
        </a>
        <hr className="border-zinc-700 border-1 mt-4"></hr>
        <div className="mt-6 justify-between text-xs">
          <span className="mr-3">
        ...
        <div className="mt-6 mb-8 justify-between text-xs">
          <p>© 2023 TikTok</p>
        </div>  
      </div>      
  );
